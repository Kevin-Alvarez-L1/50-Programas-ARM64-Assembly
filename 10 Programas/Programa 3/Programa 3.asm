...
_start:
    ...
    sub x21, x19, x20               // x21 = x19 (num1) - x20 (num2)
    ...
    // Convertir el resultado de la resta a cadena y mostrarlo
    mov x0, x21                     // Mover el resultado (resta) a x0
